...
import {
  ...
  getRange, applyRange,
  scrollIntoView, getAtAndIndex,getPrecedingRangeBackspace
} from './util'
...
export default {
  ...
  methods: {
    ...
    handleDelete (e) {
      const range = getPrecedingRangeBackspace()
      if (range) {
    ...
    insertHtml (html, r) {
      ...
      newElement.setAttribute('style', "color:#0F64FF")
    ...
    insertItem () {
      ...
      console.log(start,r.endContainer)
